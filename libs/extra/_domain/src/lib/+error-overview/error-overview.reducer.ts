...
import * as errorActions from './error-overview.actions';
import { ErrorEntity } from './error-overview.models';
...
export function errorOverviewReducer(state: ErrorState | undefined, action: Action): ErrorState {
