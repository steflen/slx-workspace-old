...
import { SettingsLandingDesktopComponent } from './components/settings-landing-desktop/settings-landing-desktop.component';
import { SettingsLayoutDesktopComponent } from './components/settings-layout-desktop/settings-layout-desktop.component';

@NgModule({
  declarations: [SettingsLayoutDesktopComponent, SettingsLandingDesktopComponent],
  imports: [
    CommonModule,
    SharedCommonModule,
    ...
    RouterModule.forChild([
      {
        path: '',
        component: SettingsLayoutDesktopComponent,
        data: { title: 'Settings', animation: 'settings' },
        children: [
          {
            path: '',
            component: SettingsLandingDesktopComponent,
...
export class SettingsShellDesktopModule {
  constructor(@Optional() @SkipSelf() parentModule: SettingsShellDesktopModule) {
    if (parentModule) {
  ...
  static forRoot(environment: Environment): ModuleWithProviders<any> {
    return {
      ngModule: SettingsShellDesktopModule,
      providers: [
        {
